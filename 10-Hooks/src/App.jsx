            ...
            <div className="w-full h-screen flex justify-center flex-col">
                <div className="w-full max-w-xl mx-auto rounded-lg p-4 my-12 bg-slate-600 text-white">
                    ...
                    <div className="flex rounded-lg overflow-hidden mb-4">
                        <input type="text" value={password} className="outline-none w-full py-3 px-2 text-black" placeholder="Password" readOnly ref={passRef} />
                    ...
                    <div className="flex text-sm gap-x-2">
                        <div className="flex items-center gap-x-1">
                            <input type="range" min={6} max={16} value={psLength} className="cursor-pointer" onChange={(e) => setPsLength(e.target.value)} />
                            <label>Length: {psLength}</label>
                        </div>
                        <div className="flex items-center gap-x-1">
                            <input type="checkbox" className="cursor-pointer" onChange={() => setNumberAllow((prev) => !prev)} />
                            <label>Numbers</label>
                        </div>
                        <div className="flex items-center gap-x-1">
                            <input type="checkbox" className="cursor-pointer" onChange={() => setCharAllow((prev) => !prev)} />
